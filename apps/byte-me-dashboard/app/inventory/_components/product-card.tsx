...
export default function ProductCard({
  ...
  return (
    <Card className="h-fit w-full max-w-3xs transition-transform duration-300 ease-in-out hover:-translate-y-2">
      <Image
        src={src}
        alt={`${name} image`}
        width={600}
      ...
      <div className="flex h-full flex-col justify-between gap-4">
        ...
        <CardFooter className="flex w-full justify-center gap-4 p-0">
